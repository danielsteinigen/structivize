...
class RendererKg(Renderer):
    ...
    def _node_style(self, node, classes, properties, individuals):
        ...
        if node in properties:
            return {"shape": self.tool_config["shape_prop"], "style": self.tool_config["style_prop"], "color": self.tool_config["color_prop"], "fillcolor": self.tool_config["color_prop_fill"], "fontcolor": self.tool_config["color_prop_font"]}
    ...
    def _edge_style(self, predicate):
        if predicate in {RDF.type}:
            return {"style": self.tool_config["line_type"], "color": self.tool_config["color_pred_type"], "fontcolor": self.tool_config.get("color_edge_font", "#000000")}
        if predicate in {RDFS.subClassOf, RDFS.subPropertyOf}:
            return {"style": self.tool_config["line_sub"], "color": self.tool_config["color_pred_sub"], "fontcolor": self.tool_config.get("color_edge_font", "#000000")}
        if predicate in {OWL.equivalentClass, OWL.sameAs}:
            return {"style": self.tool_config["line_eq"], "color": self.tool_config["color_pred_eq"], "fontcolor": self.tool_config.get("color_edge_font", "#000000")}
        return {"style": self.tool_config["line_default"], "color": self.tool_config["color_pred_default"], "fontcolor": self.tool_config.get("color_edge_font", "#000000")}
...
class RendererKgXml(RendererKg):
    DEFAULT_TOOL_CONFIGS = {
        "graphviz": { "bgcolor": "#FFFFFF", "direction": "TB", "shape_class": "box", "style_class": "rounded,filled", "color_class": "#F37021", "color_class_fill": "#FFF0E0", "color_class_font": "#B34000", "shape_prop": "hexagon", "style_propo": "", "color_prop": "#005A9C", "color_prop_fill": "#FFFFFF", "color_prop_font": "#005A9C", "shape_ind": "ellipse", "style_ind": "filled", "color_ind": "#005A9C", "color_ind_fill": "#E6F2FF", "color_ind_font": "#003366", "shape_default": "circle", "style_default": "", "color_default": "#808080", "color_default_fill": "#FFFFFF", "color_default_font": "#333333", "line_type": "solid", "color_pred_type": "#F37021", "line_sub": "dashed", "color_pred_sub": "#005A9C", "line_eq": "dotted", "color_pred_eq": "#333333", "line_default": "solid", "color_pred_default": "#666666" },
        "networkx": {},
    }
    FILE_EXT = "xml"
